...
class CorrelationScreen extends StatefulWidget {
  const CorrelationScreen({required this.parameters, super.key});
                            ...
                            PopupMenuButton(
                                ...
                                itemBuilder: (BuildContext context) =>
                                    <PopupMenuEntry<int>>[
                                      const PopupMenuItem<int>(
                                        value: 0,
                                        child: Text('same interval'),
                                      ),
                                      const PopupMenuItem<int>(
                                        value: 1,
                                        child: Text('next interval'),
                                      ),
                                      const PopupMenuItem<int>(
                                        value: 2,
                                        child: Text('2 intervals'),
                                      ),
                                      const PopupMenuItem<int>(
                                        value: 3,
                                        child: Text('3 intervals'),
                                      ),
                                      const PopupMenuItem<int>(
                                        value: 4,
                                        child: Text('4 intervals'),
                                      ),
                                    ]),
